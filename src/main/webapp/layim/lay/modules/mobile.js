...
layui.define(["laytpl", "upload-mobile", "layer-mobile", "zepto"], function (i) {
    var e = "2.0.0", a = layui.zepto, t = layui.laytpl, n = layui["layer-mobile"], l = layui["upload-mobile"],
    ...
    n.popBottom = function (i) {
        ...
        var e = T(), a = e.elem.find(".layim-chat-status");
    ...
    var p = function (i) {
            ...
            return i = i || {}, "history" === i.type && (i.item = i.item || "d.sortHistory"), ["{{# var length = 0; layui.each(" + i.item + ", function(i, data){ length++; }}", '<li layim-event="chat" data-type="' + i.type + '" data-index="' + (i.index ? "{{" + i.index + "}}" : "{{data.type}}{{data.id}}") + '" class="layim-' + ("history" === i.type ? "{{data.type}}" : i.type) + '{{data.id}} {{ data.status === "offline" ? "layim-list-gray" : "" }}"><div><img src="{{data.avatar}}"></div><span>{{ data.username||data.groupname||data.name||"佚名" }}</span><p>{{ data.remark||data.sign||"" }}</p><span class="layim-msg-status">new</span></li>', "{{# }); if(length === 0){ }}", '<li class="layim-null">' + (e[i.type] || "暂无数据") + "</li>", "{{# } }}"].join("")
        }, f = function (i, e, a) {
            return ['<div class="layim-panel' + (e ? " layui-m-anim-left" : "") + '">', '<div class="layim-title" style="background-color: {{d.base.chatTitleColor}};">', "<p>", a ? '<i class="layui-icon layim-chat-back" layim-event="back">&#xe603;</i>' : "", '{{ d.title || d.base.title }}<span class="layim-chat-status"></span>', "</p>", "</div>", '<div class="layui-unselect layim-content">', i, "</div>", "</div>"].join("")
        },
        ...
        C = {message: {}, chat: []}, k = function (i) {
            ...
            return n.open({
                type: 1, shade: !1, shadeClose: !1, anim: -1, content: i, success: function (i) {
                    b = a(i), A(b.find(".layui-layim"))
                }
            })
        }, N = function (i, e) {
            i = i || {};
            var l = {base: C.base, local: C.local, title: i.title || "", data: i.data};
            return n.open({
                type: 1,
                shade: !1,
                shadeClose: !1,
                ...
                success: function (e) {
                    var t = a(e);
                    t.prev().find(".layim-panel").addClass("layui-m-anim-lout"), i.success && i.success(e), i.isChat || A(t.find(".layim-content"))
                },
                end: i.end
            })
        }, L = function (i, e, t) {
            return i = i || {}, i.id ? (n.close(L.index), L.index = N({
                ...
                isChat: !0,
                success: function (e) {
                    x = a(e), B(), $(), delete C.message[i.type + i.id], _("Msg");
                    var t = T(), n = t.elem.find(".layim-chat-main");
                    layui.each(r.chatChange, function (i, e) {
                        e && e(t)
                    }), A(n), t.textarea.on("focus", function () {
                        setTimeout(function () {
            ...
            var i = {
                    ...
                    mine: !0
                }, e = T(), a = e.elem.find(".layim-chat-main ul"), l = e.data, s = C.base.maxLength || 3e3,
            ...
            i = i || {};
            var e = {}, a = T(), n = a.data || {}, l = n.id == i.id && n.type == i.type;
            if (i.timestamp = i.timestamp || (new Date).getTime(), i.system || F(i), I = JSON.parse(JSON.stringify(i)), C.base.voice && D(), !x && i.content || !l) {
                if (C.message[i.type + i.id]) C.message[i.type + i.id].push(i); else if (C.message[i.type + i.id] = [i], "friend" === i.type) {
                    ...
                    layui.each(C.friend, function (e, a) {
                        if (layui.each(a.list, function (e, a) {
                                if (a.id == i.id) return a.type = "friend", a.name = a.username, C.chat.push(a), s = !0
                            }), s) return !0
                    }), s || (i.name = i.username, i.temporary = !0, C.chat.push(i))
                } else if ("group" === i.type) {
                    var o;
                    layui.each(C.group, function (e, a) {
                        if (a.id == i.id) return a.type = "group", a.name = a.groupname, C.chat.push(a), o = !0
            ...
            if (H(i), x && l) {
                var c = x.find(".layim-chat"), d = c.find(".layim-chat-main ul");
                i.system ? d.append('<li class="layim-chat-system"><span>' + i.content + "</span></li>") : "" !== i.content.replace(/\s/g, "") && (i.timestamp - (q.time || 0) > 6e4 && (d.append('<li class="layim-chat-system"><span>' + layui.data.date(i.timestamp) + "</span></li>"), q.time = i.timestamp), d.append(t(w).render(i))), J()
            }
        }, F = function (i) {
            ...
            var i = layui.data("layim-mobile")[C.mine.id] || {}, e = T(), a = i.chatlog || {},
            ...
            var i = T(), e = i.elem.find(".layim-chat-main"), a = e.find("ul"), t = a.children(".layim-chat-li");
            if (t.length >= d) {
                var n = t.eq(0);
            ...
            chat: function (i) {
                ...
                var e = i.data("type") || "images", a = {images: "uploadImage", file: "uploadFile"}, t = T(),
                    s = C.base[a[e]] || {};
                l({
                ...
                var e = U.playAudio.audio, a = e || document.createElement("audio"), t = function () {
                    a.pause(), i.removeAttr("status"), i.find("i").html("&#xe652;")
                };
                return a.play ? void(i.attr("status") ? t() : (e || (a.src = i.data("src")), a.play(), i.attr("status", "pause"), U.playAudio.audio = a, i.find("i").html("&#xe651;"), a.onended = function () {
                    t()
                }, a.onerror = function () {
                    n.msg("播放音频源异常")
                })) : n.msg("您的浏览器不支持audio")
