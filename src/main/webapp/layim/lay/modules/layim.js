...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "测试", e = layui.jquery, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
        o = "layim-this", d = 20, r = {}, u = function () {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (a[0]) {
            var s = w.find(".layim-chat-list"), o = s.find(".layim-chatlist-" + i.type + i.id),
                d = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), u = a.children(".layim-chat-box");
            return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({height: w.height()}).show(), u.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), u.append(n(f).render(l)), I(i), E()), q(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || P(), D(i), Q(), C
        }
        l.first = !0;
        var c = C = t.open({
            type: 1,
            ...
            full: function (i) {
                t.style(c, {width: "100%", height: "100%"}, !0), E()
            },
            resizing: E,
            restore: E,
            min: function () {
        ...
        if (x) {
            ...
            if (i.historyTime = (new Date).getTime(), t[i.type + i.id] = i, a.history = t, layui.data("layim", {
                ...
                e[i.type + i.id] = i;
                var o = n(c({type: "history", item: "d.data"})).render({data: e});
                s.prepend(o), s.find(".layim-null").remove()
            }
        }
    }, $ = function () {//这里是PC端聊天界面点击发送按钮后的事件处理
        // alert(1111);
        var i = {
        ...
        //temp_content = temp_content.replace(reg, "<a href='$1$2'>$1$2</a>");
        ...
        if (w) {
            ...
            var r = w.find(".layim-chat").eq(l), u = r.find(".layim-chat-main ul");
        ...
        status: function (i, a) {
            ...
            i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ti.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                success: function (a) {
                    ...
                    u && s.css({width: e(window).width() - 22 - (c || 200)}), t.data = e.extend(t.data, {id: n.data.id}), S(t, function (a) {
            ...
            var a = ti.playAudio.audio, e = a || document.createElement("audio"), n = function () {
